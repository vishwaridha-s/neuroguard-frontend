  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>Health Summary Overview</p>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', opacity: 0.9, marginBottom: '0.5rem' }}>Last Heart Rate</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', opacity: 0.9, marginBottom: '0.5rem' }}>Average Heart Rate</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', opacity: 0.9, marginBottom: '0.5rem' }}>Total Alerts</div>
          <div style={{ fontSize: '2.5rem', fontWeight: '700' }}>{allAlerts.length}</div>
          <div style={{ fontSize: '0.9rem', opacity: 0.8, marginTop: '0.25rem' }}>notifications</div>
        </div>
      </div>
          ...
          <table style={{
            ...
            <thead>
              <tr style={{ background: '#f8f9fa' }}>
                {allVitals[0] && Object.keys(allVitals[0]).map(k => (
                  <th key={k} style={{
